// Piratwhist Online Multiplayer (v0.2.108)
...
// --- v0.2.108: dynamic round-table board (2–8 players) ---
...
function positionPlayBoard(n){
  ...
  if (isMobile){
    // v0.2.108 Dev + layout: SceneShift for mobile to utilize top space and
    ...
    const slot = {
      // v0.2.108 Mobile: lift top seats so the top player stays visible.
...
// v0.2.108 PC HUD sync + button wiring
function syncPcHud(){
...
// v0.2.108 no-fly zone: avoid overlap between hand area and the bottom-left opponent seat on PC
