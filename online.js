// Piratwhist Online Multiplayer (v0.2.80)
...
function positionPlayBoard(n){
  ...
  if (isMobile){
    // v0.2.80 Dev + layout: SceneShift for mobile to utilize top space and
    ...
    const slot = {
      // v0.2.80 Mobile: push the whole "scene" up to utilize top space and
...
// v0.2.80 PC HUD sync + button wiring
function syncPcHud(){
...
// v0.2.80 no-fly zone: avoid overlap between hand area and the bottom-left opponent seat on PC
