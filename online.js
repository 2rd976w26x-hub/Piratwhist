// Piratwhist Online Multiplayer (1.2.7)
...
// --- 1.2.7: dynamic round-table board (2–8 players) ---
...
function pcLayoutTunerActive(){
  // 1.2.7: Layout-tuner panelet må kun være synligt for spillernavn "LaBA".
...
function positionPlayBoard(n){
  ...
  if (isMobile){
    // 1.2.7 Dev + layout: SceneShift for mobile to utilize top space and
...
// 1.2.7 PC HUD sync + button wiring
function syncPcHud(){
...
// 1.2.7 no-fly zone: avoid overlap between hand area and the bottom-left opponent seat on PC
